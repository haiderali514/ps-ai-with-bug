...
// Fix: Corrected import paths for types to import from specific files.
import { DocumentSettings, ExportFormat } from '../types/document';
import { HistoryState } from '../types/history';
import { MoveSession, SnapLine, TransformSession } from '../types/interactions';
import { Layer } from '../types/layers';
import { AnySubTool, BrushShape, EditorTool, TransformMode } from '../types/tools';
