...
import CanvasArea from '../../canvas/components/CanvasArea';
import ConfirmModal from '../../../components/modals/ConfirmModal';
import ExportModal from '../../../components/modals/ExportModal';
import { useEditor } from '../../../state/EditorProvider';
import RightSidebarContainer from './RightSidebarContainer';
import LeftSidebar from './LeftSidebar';
import ContextualTaskbar from '../contextual-bars/ContextualTaskbar';
...
const EditorShell: React.FC<EditorShellProps> = ({ onClose, onNew }) => {
    ...
    return (
        <div className="w-screen h-screen bg-[#181818] flex flex-col font-sans overflow-hidden">
            <input ref={fileInputRef} type="file" accept=".aiws" onChange={handleFileChange} className="hidden" />
            <EditorHeader 
