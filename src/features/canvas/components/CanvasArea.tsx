...
import InteractionLayer, { InteractionCanvasHandle } from './InteractionLayer';
...
const CanvasArea: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Fix: Removed zoom and pan from dependency array to prevent recentering on zoom/pan.
  }, [docSettings?.width, docSettings?.height]); 
